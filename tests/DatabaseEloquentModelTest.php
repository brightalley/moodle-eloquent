...
class DatabaseEloquentModelTest extends TestCase
{
    ...
    public function testNewInstanceReturnsNewInstanceWithAttributesSet()
    {
        ...
        $this->assertInstanceOf('local_eloquent\tests\EloquentModelStub', $instance);
    ...
    {
        $model = $this->getMockBuilder('local_eloquent\tests\EloquentModelStub')->setMethods(['newQueryWithoutScopes', 'updateTimestamps'])->getMock();
    ...
    {
        $model = $this->getMockBuilder('local_eloquent\tests\EloquentModelStub')->setMethods(['newQueryWithoutScopes'])->getMock();
        $query = m::mock('Illuminate\Database\Eloquent\Builder');
        $query->shouldReceive('where')->once()->with('id', '=', 1);
        $query->shouldReceive('update')->once()->with(['timecreated' => 'foo', 'timeupdated' => 'bar'])->andReturn(1);
        $model->expects($this->once())->method('newQueryWithoutScopes')->will($this->returnValue($query));
        $model->setEventDispatcher($events = m::mock('Illuminate\Contracts\Events\Dispatcher'));
        ...
        $model->id = 1;
        $model->syncOriginal();
        $model->timecreated = 'foo';
        $model->timeupdated = 'bar';
        $model->exists = true;
        $this->assertTrue($model->save());
    }
    ...
    {
        $model = $this->getMockBuilder('local_eloquent\tests\EloquentModelEventObjectStub')->setMethods(['newQueryWithoutScopes'])->getMock();
        $query = m::mock('Illuminate\Database\Eloquent\Builder');
        $model->expects($this->once())->method('newQueryWithoutScopes')->will($this->returnValue($query));
        $model->setEventDispatcher($events = m::mock('Illuminate\Contracts\Events\Dispatcher'));
    ...
    {
        $model = $this->getMockBuilder('local_eloquent\tests\EloquentModelEventObjectStub')->setMethods(['newQueryWithoutScopes', 'updateTimestamps', 'fireModelEvent'])->getMock();
    ...
    {
        $model = $this->getMockBuilder('local_eloquent\tests\EloquentDateModelStub')->setMethods(['getDateFormat'])->getMock();
        ...
        $this->assertInstanceOf('Carbon\Carbon', $model->timecreated);
        $this->assertInstanceOf('Carbon\Carbon', $model->timeupdated);
    }
    ...
    public function testTimestampsAreReturnedAsObjectsFromPlainDatesAndTimestamps()
    {
        ...
        $model->setRawAttributes([
            'timecreated' => '2012-12-04',
            'timeupdated' => Carbon::now()->getTimestamp(),
        ]);
    ...
    public function testTimestampsAreReturnedAsObjectsOnCreate()
    {
        ...
        $this->assertInstanceOf('Carbon\Carbon', $instance->timeupdated);
        $this->assertInstanceOf('Carbon\Carbon', $instance->timecreated);
    }
    ...
    public function testDateTimeAttributesReturnNullIfSetToNull()
    {
        ...
        $this->assertNull($instance->timecreated);
    }

    public function testTimestampsAreCreatedFromStringsAndIntegers()
    {
        $model = new EloquentDateModelStub;
        $model->timecreated = '2013-05-22 00:00:00';
        $this->assertInstanceOf('Carbon\Carbon', $model->timecreated);

        $model = new EloquentDateModelStub;
        $model->timecreated = Carbon::now()->getTimestamp();
        $this->assertInstanceOf('Carbon\Carbon', $model->timecreated);
    ...
    {
        $model = $this->getMockBuilder('local_eloquent\tests\EloquentModelStub')->setMethods(['newQueryWithoutScopes', 'updateTimestamps', 'refresh'])->getMock();
        $query = m::mock('Illuminate\Database\Eloquent\Builder');
    ...
    {
        $model = $this->getMockBuilder('local_eloquent\eloquent\model')->setMethods(['newQueryWithoutScopes', 'updateTimestamps', 'touchOwners'])->getMock();
        $query = m::mock('Illuminate\Database\Eloquent\Builder');
    ...
    {
        $related1 = $this->getMockBuilder('local_eloquent\tests\EloquentModelStub')->setMethods(['newQueryWithoutScopes', 'updateTimestamps', 'refresh'])->getMock();
        $query = m::mock('Illuminate\Database\Eloquent\Builder');
    ...
    public function testPushManyRelation()
    {
        ...
        $related2 = $this->getMockBuilder('local_eloquent\tests\EloquentModelStub')->setMethods(['newQueryWithoutScopes', 'updateTimestamps', 'refresh'])->getMock();
        $query = m::mock('Illuminate\Database\Eloquent\Builder');
    ...
    public function testHasOneCreatesProperRelation()
    {
        ...
        $relation = $model->hasOne('local_eloquent\tests\EloquentModelSaveStub');
        $this->assertEquals('save_stub.eloquent_model_stub_id', $relation->getQualifiedForeignKeyName());

        $model = new EloquentModelStub;
        $this->addMockConnection($model);
        $relation = $model->hasOne('local_eloquent\tests\EloquentModelSaveStub', 'foo');
        $this->assertEquals('save_stub.foo', $relation->getQualifiedForeignKeyName());
        $this->assertSame($model, $relation->getParent());
        $this->assertInstanceOf('local_eloquent\tests\EloquentModelSaveStub', $relation->getQuery()->getModel());
    }
    ...
    public function testMorphOneCreatesProperRelation()
    {
        $model = new EloquentModelStub;
        $this->addMockConnection($model);
        $relation = $model->morphOne('local_eloquent\tests\EloquentModelSaveStub', 'morph');
        ...
        $this->assertEquals('local_eloquent\tests\EloquentModelStub', $relation->getMorphClass());
    }
    ...
    public function testCorrectMorphClassIsReturned()
    {
        ...
        try {
            $this->assertEquals('local_eloquent\tests\EloquentModelStub', $model->getMorphClass());
        } finally {
    ...
    public function testHasManyCreatesProperRelation()
    {
        $model = new EloquentModelStub;
        $this->addMockConnection($model);
        $relation = $model->hasMany('local_eloquent\tests\EloquentModelSaveStub');
        $this->assertEquals('save_stub.eloquent_model_stub_id', $relation->getQualifiedForeignKeyName());

        $model = new EloquentModelStub;
        $this->addMockConnection($model);
        $relation = $model->hasMany('local_eloquent\tests\EloquentModelSaveStub', 'foo');
    ...
    public function testMorphManyCreatesProperRelation()
    {
        $model = new EloquentModelStub;
        $this->addMockConnection($model);
        $relation = $model->morphMany('local_eloquent\tests\EloquentModelSaveStub', 'morph');
        $this->assertEquals('save_stub.morph_id', $relation->getQualifiedForeignKeyName());
        $this->assertEquals('save_stub.morph_type', $relation->getQualifiedMorphType());
        $this->assertEquals('local_eloquent\tests\EloquentModelStub', $relation->getMorphClass());
    }
    ...
    public function testBelongsToManyCreatesProperRelation()
    {
        ...
        $relation = $model->belongsToMany('local_eloquent\tests\EloquentModelSaveStub');
        ...
        $model = new EloquentModelStub;
        $this->addMockConnection($model);
        $relation = $model->belongsToMany('local_eloquent\tests\EloquentModelSaveStub', 'table', 'foreign', 'other');
    ...
    public function testRelationsWithVariedConnections()
    {
        ...
        $this->addMockConnection($model);
        $relation = $model->hasOne('local_eloquent\tests\EloquentNoConnectionModelStub');
        $this->assertEquals('non_default', $relation->getRelated()->getConnectionName());

        $model = new EloquentModelStub;
        $model->setConnection('non_default');
        $this->addMockConnection($model);
        $relation = $model->hasOne('local_eloquent\tests\EloquentDifferentConnectionModelStub');
        ...
        $model->setConnection('non_default');
        $this->addMockConnection($model);
        $relation = $model->morphOne('local_eloquent\tests\EloquentNoConnectionModelStub', 'type');
        $this->assertEquals('non_default', $relation->getRelated()->getConnectionName());

        $model = new EloquentModelStub;
        $model->setConnection('non_default');
        $this->addMockConnection($model);
        $relation = $model->morphOne('local_eloquent\tests\EloquentDifferentConnectionModelStub', 'type');
        $this->assertEquals('different_connection', $relation->getRelated()->getConnectionName());
        ...
        $model->setConnection('non_default');
        $this->addMockConnection($model);
        $relation = $model->belongsTo('local_eloquent\tests\EloquentNoConnectionModelStub');
        $this->assertEquals('non_default', $relation->getRelated()->getConnectionName());

        $model = new EloquentModelStub;
        $model->setConnection('non_default');
        $this->addMockConnection($model);
        $relation = $model->belongsTo('local_eloquent\tests\EloquentDifferentConnectionModelStub');
        $this->assertEquals('different_connection', $relation->getRelated()->getConnectionName());
        ...
        $model->setConnection('non_default');
        $this->addMockConnection($model);
        $relation = $model->hasMany('local_eloquent\tests\EloquentNoConnectionModelStub');
        $this->assertEquals('non_default', $relation->getRelated()->getConnectionName());

        $model = new EloquentModelStub;
        $model->setConnection('non_default');
        $this->addMockConnection($model);
        $relation = $model->hasMany('local_eloquent\tests\EloquentDifferentConnectionModelStub');
        $this->assertEquals('different_connection', $relation->getRelated()->getConnectionName());
        ...
        $model->setConnection('non_default');
        $this->addMockConnection($model);
        $relation = $model->hasManyThrough('local_eloquent\tests\EloquentNoConnectionModelStub', 'local_eloquent\tests\EloquentModelSaveStub');
        $this->assertEquals('non_default', $relation->getRelated()->getConnectionName());

        $model = new EloquentModelStub;
        $model->setConnection('non_default');
        $this->addMockConnection($model);
        $relation = $model->hasManyThrough('local_eloquent\tests\EloquentDifferentConnectionModelStub', 'local_eloquent\tests\EloquentModelSaveStub');
        $this->assertEquals('different_connection', $relation->getRelated()->getConnectionName());
        ...
        $model->setConnection('non_default');
        $this->addMockConnection($model);
        $relation = $model->belongsToMany('local_eloquent\tests\EloquentNoConnectionModelStub');
        $this->assertEquals('non_default', $relation->getRelated()->getConnectionName());

        $model = new EloquentModelStub;
        $model->setConnection('non_default');
        $this->addMockConnection($model);
        $relation = $model->belongsToMany('local_eloquent\tests\EloquentDifferentConnectionModelStub');
        $this->assertEquals('different_connection', $relation->getRelated()->getConnectionName());
    }
    ...
    public function testCloneModelMakesAFreshCopyOfTheModel()
    {
        ...
        $class->first = 'taylor';
        $class->last = 'otwell';
        $class->timecreated = $class->freshTimestamp();
        $class->timeupdated = $class->freshTimestamp();
        ...
        $this->assertObjectNotHasAttribute('timecreated', $clone);
        $this->assertObjectNotHasAttribute('timeupdated', $clone);
    ...
    public function testModelObserversCanBeAttachedToModels()
    {
        ...
        $events->shouldReceive('listen')->once()->with('eloquent.creating: local_eloquent\tests\EloquentModelStub', 'local_eloquent\tests\EloquentTestObserverStub@creating');
        $events->shouldReceive('listen')->once()->with('eloquent.saved: local_eloquent\tests\EloquentModelStub', 'local_eloquent\tests\EloquentTestObserverStub@saved');
    ...
    public function testModelObserversCanBeAttachedToModelsWithString()
    {
        ...
        $events->shouldReceive('listen')->once()->with('eloquent.saved: local_eloquent\tests\EloquentModelStub', 'local_eloquent\tests\EloquentTestObserverStub@saved');
        $events->shouldReceive('forget');
        EloquentModelStub::observe('local_eloquent\tests\EloquentTestObserverStub');
        EloquentModelStub::flushEventListeners();
    }
    ...
    public function testReplicateCreatesANewModelInstanceWithSameAttributeValues()
    {
        ...
        $model->id = 'id';
        $model->foo = 'bar';
        $model->timecreated = new DateTime;
        $model->timeupdated = new DateTime;
        $replicated = $model->replicate();

        $this->assertNull($replicated->id);
        $this->assertEquals('bar', $replicated->foo);
        $this->assertNull($replicated->timecreated);
        $this->assertNull($replicated->timeupdated);
    }

    public function testIncrementOnExistingModelCallsQueryAndSetsAttribute()
    {
        $model = m::mock('local_eloquent\tests\EloquentModelStub[newQuery]');
        $model->exists = true;
        $model->id = 1;
    ...
    public function testRelationshipTouchOwnersIsPropagated()
    {
        ...
        $model = m::mock('local_eloquent\tests\EloquentModelStub[partner]');
        $this->addMockConnection($model);
        $model->shouldReceive('partner')->once()->andReturn($relation);
        $model->setTouchedRelations(['partner']);

        $mockPartnerModel = m::mock('local_eloquent\tests\EloquentModelStub[touchOwners]');
    ...
    {
        $model = m::mock('local_eloquent\tests\EloquentModelStub[delete,getRelationValue]');
        $model->name = 'Spark';
        ...
        $model = m::mock('local_eloquent\tests\EloquentModelStub[delete]');
        $model->delete = 123;
    ...
    {
        $model = $this->getMockBuilder('local_eloquent\tests\EloquentKeyTypeModelStub')->setMethods(['newQueryWithoutScopes', 'updateTimestamps', 'refresh'])->getMock();
        $query = m::mock('Illuminate\Database\Eloquent\Builder');
...
class EloquentModelStub extends Model
{
    ...
    protected $guarded = [];
    protected $morph_to_stub_type = 'local_eloquent\tests\EloquentModelSaveStub';
    ...
    {
        return $this->belongsTo('local_eloquent\tests\EloquentModelSaveStub');
    }
    ...
    {
        return $this->belongsTo('local_eloquent\tests\EloquentModelSaveStub', 'foo');
    }
...
class EloquentModelDynamicHiddenStub extends \local_eloquent\eloquent\model
{
    protected $table = 'stub';
    protected $guarded = [];
...
class EloquentModelDynamicVisibleStub extends \local_eloquent\eloquent\model
{
    protected $table = 'stub';
    protected $guarded = [];
...
class EloquentModelNonIncrementingStub extends \local_eloquent\eloquent\model
{
    protected $table = 'stub';
    protected $guarded = [];
...
class EloquentModelEventObjectStub extends \local_eloquent\eloquent\model
{
    protected $events = [
