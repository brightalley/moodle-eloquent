...
class DatabaseConnectionTest extends TestCase
{
    ...
    {
        $pdo = $this->getMockBuilder('local_eloquent\tests\DatabaseConnectionTestMockPDO')->setMethods(['prepare'])->getMock();
        $writePdo = $this->getMockBuilder('local_eloquent\tests\DatabaseConnectionTestMockPDO')->setMethods(['prepare'])->getMock();
    ...
    {
        $pdo = $this->createMock('local_eloquent\tests\DatabaseConnectionTestMockPDO');
    ...
    {
        $pdo = $this->getMockBuilder('local_eloquent\tests\DatabaseConnectionTestMockPDO')->setMethods(['beginTransaction', 'commit'])->getMock();
    ...
    {
        $pdo = $this->getMockBuilder('local_eloquent\tests\DatabaseConnectionTestMockPDO')->setMethods(['beginTransaction', 'commit', 'rollBack'])->getMock();
        $mock = $this->getMockConnection([], $pdo);
    ...
    public function testRunMethodNeverRetriesIfWithinTransaction()
    {
        ...
        $pdo = $this->getMockBuilder('local_eloquent\tests\DatabaseConnectionTestMockPDO')->setMethods(['beginTransaction'])->getMock();
        $mock = $this->getMockConnection(['tryAgainIfCausedByLostConnection'], $pdo);
        $pdo->expects($this->once())->method('beginTransaction');
