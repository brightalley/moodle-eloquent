...
class DatabaseEloquentBuilderTest extends TestCase
{
    ...
    {
        $model = $this->getMockModel();
        $model->shouldReceive('findOrNew')->once()->andReturn(m::mock('local_eloquent\eloquent\model'));
        ...
        $this->assertInstanceOf('local_eloquent\eloquent\model', $result);
    }
    ...
    public function testGetModelsProperlyHydratesModels()
    {
        ...
        $model = m::mock('local_eloquent\eloquent\model[getTable,getConnectionName,hydrate]');
    ...
    {
        $model = m::mock('local_eloquent\eloquent\model');
...
class EloquentBuilderTestModelParentStub extends Model
{
    public function foo()
    {
        return $this->belongsTo('local_eloquent\tests\EloquentBuilderTestModelCloseRelatedStub');
    }

    public function address()
    {
        return $this->belongsTo('local_eloquent\tests\EloquentBuilderTestModelCloseRelatedStub', 'foo_id');
    }

    public function activeFoo()
    {
        return $this->belongsTo('local_eloquent\tests\EloquentBuilderTestModelCloseRelatedStub', 'foo_id')->where('active', true);
    }
}
...
class EloquentBuilderTestModelCloseRelatedStub extends Model
{
    public function bar()
    {
        return $this->hasMany('local_eloquent\tests\EloquentBuilderTestModelFarRelatedStub');
    }
...
class EloquentBuilderTestModelSelfRelatedStub extends Model
{
    ...
    {
        return $this->belongsTo('local_eloquent\tests\EloquentBuilderTestModelSelfRelatedStub', 'parent_id', 'id', 'parent');
    }

    public function childFoo()
    {
        return $this->hasOne('local_eloquent\tests\EloquentBuilderTestModelSelfRelatedStub', 'parent_id', 'id');
    }

    public function childFoos()
    {
        return $this->hasMany('local_eloquent\tests\EloquentBuilderTestModelSelfRelatedStub', 'parent_id', 'id', 'children');
    }

    public function parentBars()
    {
        return $this->belongsToMany('local_eloquent\tests\EloquentBuilderTestModelSelfRelatedStub', 'self_pivot', 'child_id', 'parent_id', 'parent_bars');
    }

    public function childBars()
    {
        return $this->belongsToMany('local_eloquent\tests\EloquentBuilderTestModelSelfRelatedStub', 'self_pivot', 'parent_id', 'child_id', 'child_bars');
    }

    public function bazes()
    {
        return $this->hasMany('local_eloquent\tests\EloquentBuilderTestModelFarRelatedStub', 'foreign_key', 'id', 'bar');
    }
}
