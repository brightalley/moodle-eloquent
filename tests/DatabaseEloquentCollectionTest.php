...
class DatabaseEloquentCollectionTest extends TestCase
{
    ...
    {
        $mockModel = m::mock('local_eloquent\eloquent\model');
        $mockModel->shouldReceive('getKey')->andReturn(1);
        $mockModel2 = m::mock('local_eloquent\eloquent\model');
        $mockModel2->shouldReceive('getKey')->andReturn(2);
        $mockModel3 = m::mock('local_eloquent\eloquent\model');
    ...
    {
        $mockModel1 = m::mock('local_eloquent\eloquent\model');
    ...
    {
        $one = m::mock('local_eloquent\eloquent\model');
        $one->shouldReceive('getKey')->andReturn(1);

        $two = m::mock('local_eloquent\eloquent\model');
        $two->shouldReceive('getKey')->andReturn(2);

        $three = m::mock('local_eloquent\eloquent\model');
