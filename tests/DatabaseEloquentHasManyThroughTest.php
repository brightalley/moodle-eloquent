...
class DatabaseEloquentHasManyThroughTest extends TestCase
{
    ...
    public function testEagerConstraintsAreProperlyAddedWithCustomKey()
    {
        ...
        $country = m::mock('local_eloquent\eloquent\model');
    ...
    protected function getRelationArguments()
    {
        ...
        $user->shouldReceive('getCreatedAtColumn')->andReturn('timecreated');
        $user->shouldReceive('getUpdatedAtColumn')->andReturn('timeupdated');
...
class EloquentHasManyThroughModelStub extends \local_eloquent\eloquent\model
{
    public $country_id = 'foreign.value';
}

class EloquentHasManyThroughSoftDeletingModelStub extends \local_eloquent\eloquent\model
{
    use SoftDeletes;
    public $table = 'users';
}
